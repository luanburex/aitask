...
public class DefaultResultFetcher implements IResultFetcher {
    ...
    public Map<String, Object> fetch(Map<String, Object> datamap) {
        Config exefile = Config.instance((String) exedata.get("pathExedata"));
        String result = FileUtil.readFile((String) exedata.get("pathResult"));
        String log = FileUtil.readFile((String) exedata.get("pathLog"));
        /**
