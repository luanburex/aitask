...
public class CmdTaskTest implements Constants{
    ...
    public void testSimpleRun() throws Exception{
        ...
        ITaskBuilder ts = TaskDirector.getBuilder(Mapper.parseXML(xml_str), TASK_TYPE_CMD);
    ...
    public void testInterruptSerialRun() throws Exception{
        ITaskBuilder ts = TaskDirector.getCmdTaskBuilder(FileUtils.readFileInClasspath(
